...
#define BUTTON_POWER        15  // Power button (positive edge triggered)
...
#define LED_POWER_ON        0   // Power-on indicator LED (on when power is enabled)
...
#define POWER_OUTPUT        1   // Power control output (LOW = power ON, HIGH = power OFF)
